...
public class WWSatellite {
	...
	public WWSatellite(WorldWindow wwd, Satellite sat,AbsoluteDate date) throws IOException, XMLStreamException {
        ...
        String filePath = "C:\\eclipse-workspace\\OrbitSimulation\\testData\\collada\\GlobeStar\\ImageToStl.com_globalstar.dae";
        satModel = ColladaRoot.createAndParse(filePath);
	...
	public void updatePosition(WorldWindow wwd, AbsoluteDate date) {
		...
		//System.out.println(this.satModel.getPosition() + " Time: " + date.toString(TLECommon.UTC));
	}
