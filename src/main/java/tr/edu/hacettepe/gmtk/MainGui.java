...
public class MainGui extends Application{
    ...
    public void start(Stage stage) throws FileNotFoundException {
        ...
        Image slowIcon = new Image(slowInputStream);
        ...
        Image playIcon = new Image(playInputStream);
        ...
        Image speedIcon = new Image(speedInputStream);
        ...
        Image addSatIcon = new Image(addSatInputStream);
